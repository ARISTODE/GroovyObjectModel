...
class Main {
    public static void main(String[] args) {
        ...
        // self is passed to the method automatically as this(ObjectModel.Base).

        // Testing
        // Top Object checking
        assert str1.callmethod("ceylon", str2) == -1;
        assert str1.callmethod("class_name") == "ObjectModel.RyString" : "class name method fail (ObjectModel.TopObject)";
